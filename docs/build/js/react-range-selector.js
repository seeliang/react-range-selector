...
var rangeToList = exports.rangeToList = function rangeToList(range) {
...
var _takeRight = __webpack_require__(147);
...
var RangeSelector = function (_React$Component) {
  ...
  function RangeSelector(props) {
    ...
    _this.list = [];
    if (props.range) {
      _this.list = (0, _helpers.rangeToList)(props.range);
    }
    if (props.customiseRange) {
      _this.list = props.customiseRange;
    }
  ...
  _createClass(RangeSelector, [{
    key: 'addNewNumber',
    value: function addNewNumber(array, number) {
      array.push(number);
      return (0, _sortBy2.default)((0, _takeRight2.default)(array, 2));
    }
  }, {
    key: 'createList',
    value: function createList() {
      ...
      if (this.props.range !== undefined) {
        rangeStart = this.props.range[0], rangeEnd = this.props.range[1];
      ...
      inputList = rangeList.map(function (number, i) {
        var checkboxName = _this2.props.componentName + '_' + _this2.props.name.replace(/\s/g, '-').toLowerCase() + '-' + i,
            selected = _this2.isInSelected(i),
            stateClassSet = _this2.stateClasslist(i);
        return _react2.default.createElement(_checkbox2.default, {
          inputChecked: _this2.updateSelected,
          isSelected: selected,
          key: i,
          labelContent: number,
          linked: checkboxName,
    ...
    key: 'newlySelected',
    value: function newlySelected(selected, number) {
      var newlySelected = selected.slice();
    ...
    key: 'updateSelected',
    value: function updateSelected(number) {
      var _this3 = this;

      var clickSelected = this.newlySelected(this.state.selected, number);
      ...
      this.setState(function (prev) {
        var justSelected = _this3.newlySelected(prev.selected, number);
    ...
    key: 'isInSelected',
    value: function isInSelected(number) {
      var start = void 0,
          end = void 0;
      if (this.state.selected.length < 1) {
        return false;
      }
      start = this.state.selected[0], end = this.state.selected[1];
    ...
    key: 'stateClasslist',
    value: function stateClasslist(number) {
      var inRangeClass = 'is-in-range',
          startClass = 'is-start';
      var start = this.state.selected[0],
    ...
    value: function render() {
      ...
      if (Array.isArray(this.props.range) && Array.isArray(this.props.customiseRange)) {
        throw new Error('Please use range or customiseRange, not both');
      } else if (Array.isArray(this.props.range) === false && Array.isArray(this.props.customiseRange) === false) {
...
var _rangeToList = __webpack_require__(24);

Object.keys(_rangeToList).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _rangeToList[key];
    }
  });
});

var _mappingSelectedIndexToResult = __webpack_require__(25);

Object.keys(_mappingSelectedIndexToResult).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _mappingSelectedIndexToResult[key];
    }
  });
});

var _initialFormState = __webpack_require__(45);

Object.keys(_initialFormState).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _initialFormState[key];
    }
  });
});

var _generatePropsWithData = __webpack_require__(46);

Object.keys(_generatePropsWithData).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _generatePropsWithData[key];
    }
  });
});
...
exports.initialFormState = undefined;
...
var initialFormState = exports.initialFormState = function initialFormState(selectors) {
  return selectors.reduce(function (r, i) {
    if (!i.initialSelected) {
      return r;
    }
    var name = i.name,
        initialSelected = i.initialSelected,
        range = i.range,
        customiseRange = i.customiseRange;

    var list = [];
    if (range) {
      list = (0, _rangeToList.rangeToList)(range);
    }
    if (customiseRange) {
      list = customiseRange;
    }
...
var generatePropsWithData = exports.generatePropsWithData = function generatePropsWithData(data) {
  var name = data.name,
      initialSelected = data.initialSelected,
      customiseRange = data.customiseRange,
      range = data.range,
      callback = data.callback;

  var rangeData = {};
  if (customiseRange) {
    rangeData = { customiseRange: customiseRange };
  }
  if (range) {
...
var InputCheckbox = function (_React$Component) {
  ...
  function InputCheckbox(props) {
    ...
    var mainClass = 'range-selector__item-input';
  ...
  _createClass(InputCheckbox, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          labelContent = _props.labelContent,
          stateClass = _props.stateClass;

      return _react2.default.createElement(
        'div',
        { className: this.className.mainRender + ' ' + stateClass },
...
var baseFlatten = __webpack_require__(49),
    baseOrderBy = __webpack_require__(55),
...
var _loadOption = __webpack_require__(153);

var _loadOption2 = _interopRequireDefault(_loadOption);
...
var RangeSelectorGroup = function (_React$Component) {
  _inherits(RangeSelectorGroup, _React$Component);

  function RangeSelectorGroup() {
    _classCallCheck(this, RangeSelectorGroup);

    return _possibleConstructorReturn(this, (RangeSelectorGroup.__proto__ || Object.getPrototypeOf(RangeSelectorGroup)).apply(this, arguments));
  }

  _createClass(RangeSelectorGroup, [{
    key: 'render',
    value: function render() {
      var rangeSelectors = [],
          selectors = this.props.selectors;
      rangeSelectors = selectors.map(function (selector, i) {
        return _react2.default.createElement(_index2.default, { componentName: 'range-selector',
  ...
  return RangeSelectorGroup;
}(_react2.default.Component);

_loadOption2.default.forEach(function (option) {
  (0, _reactDom.render)(_react2.default.createFactory(RangeSelectorGroup)(option), document.getElementById(option.DOMid));
});
