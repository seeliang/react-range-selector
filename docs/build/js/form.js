...
var Form = function (_React$Component) {
  ...
  function Form(props) {
    ...
    _this.state = _extends({}, (0, _index.initialFormState)(selectors));
    return _this;
  }

  _createClass(Form, [{
    key: 'listOfSelectors',
    value: function listOfSelectors() {
      var _this2 = this;

      return selectors.map(function (selector) {
        var data = _extends({}, selector, {
          callback: function callback(data) {
            return _this2.rangeUpdate(data);
          }
        });
        return _react2.default.createElement(_index2.default, (0, _index.generatePropsWithData)(data));
      });
    }
  }, {
    key: 'rangeUpdate',
    value: function rangeUpdate(_ref) {
      var selectedIndex = _ref.selectedIndex,
          section = _ref.section,
          values = _ref.values;

      this.setState(function (prev) {
        var newSet = prev.indexRange,
