...
/***/ function(module, exports, __webpack_require__) {
	...
	var RangeSelectorGroup = (function (_React$Component) {
	  ...
	  function RangeSelectorGroup() {
	    ...
	    _get(Object.getPrototypeOf(RangeSelectorGroup.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(RangeSelectorGroup, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_indexJs2['default'], { componentName: 'range-selector',
	          name: 'Seats',
	          range: [2, 7]
	        }),
	        _react2['default'].createElement(_indexJs2['default'], { componentName: 'range-selector',
	...
	(0, _reactDom.render)(_react2['default'].createElement(RangeSelectorGroup, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputCheckboxJs = __webpack_require__(160);

	var _inputCheckboxJs2 = _interopRequireDefault(_inputCheckboxJs);

	var _lodashCollectionSortBy = __webpack_require__(161);

	var _lodashCollectionSortBy2 = _interopRequireDefault(_lodashCollectionSortBy);

	var _lodashArrayTakeRight = __webpack_require__(212);

	var _lodashArrayTakeRight2 = _interopRequireDefault(_lodashArrayTakeRight);
	...
	var RangeSelector = (function (_React$Component) {
	  ...
	  _createClass(RangeSelector, [{
	    ...
	    value: function addNewNumber(array, number) {
	      array.push(number);
	      return (0, _lodashCollectionSortBy2['default'])((0, _lodashArrayTakeRight2['default'])(array, 2));
	    }
	  }, {
	    key: 'updateSelected',
	    value: function updateSelected(number) {
	      var newlySelected = this.state.selected.slice();
	    ...
	    value: function render() {
	      ...
	      if (this.props.range && this.props.customiseRange) {
	        return _react2['default'].createElement(
	          'h1',
	          null,
	          'Please use range or customiseRange, not both'
	        );
	      } else if (!this.props.range && !this.props.customiseRange) {
	        return _react2['default'].createElement(
	          'h1',
	          null,
	          'Please set range or customiseRange'
	        );
	      }
	      ...
	      inputList = rangelist.map(function (number, i) {
	        checkboxName = _this.props.componentName + '_' + _this.props.name.replace(/\s/g, '-').toLowerCase() + '-' + i;
	        selected = _this.isInSelected(i);
	        stateClassSet = _this.stateClasslist(i);

	        return _react2['default'].createElement(_inputCheckboxJs2['default'], {
	          inputChecked: _this.updateSelected,
	          isSelected: selected,
	          key: i,
	          labelContent: number,
	          linked: checkboxName,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputCheckbox = (function (_React$Component) {
	  ...
	  function InputCheckbox(props) {
	    ...
	    _get(Object.getPrototypeOf(InputCheckbox.prototype), 'constructor', this).call(this, props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCallback = __webpack_require__(162),
	    baseMap = __webpack_require__(202),
	    baseSortBy = __webpack_require__(208),
	    compareAscending = __webpack_require__(209),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var equalArrays = __webpack_require__(167),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arraySome = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLength = __webpack_require__(178),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCompareAscending = __webpack_require__(210);
